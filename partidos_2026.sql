-- ============================================================
-- FIFA MUNDIAL 2026 - Calendario Oficial (Fase de Grupos)
-- Ejecutar en: Supabase > SQL Editor
-- ⚠️  ADVERTENCIA: Elimina todos los datos de prueba existentes
-- ============================================================

-- PASO 1: Agregar columnas estadio y ciudad (si no existen)
ALTER TABLE partidos ADD COLUMN IF NOT EXISTS estadio TEXT;
ALTER TABLE partidos ADD COLUMN IF NOT EXISTS ciudad  TEXT;

-- PASO 2: Limpiar datos de prueba (orden respeta FK constraints)
DELETE FROM pronosticos;
DELETE FROM pronostico_campeon;
DELETE FROM partidos;

-- ============================================================
-- PASO 3: Insertar los 72 partidos de la Fase de Grupos
-- Todas las fechas en UTC. La app muestra en tu zona horaria.
-- ============================================================
...
-- ── GRUPO B: Canadá · Bosnia y Herzegovina · Suiza · Qatar ─────────────
